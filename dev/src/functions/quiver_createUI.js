...
var pasteButton = new ui.ImageButton(ui.scriptLocation + "/assets/quiver_text-paste_v01.png");
...
var importFileButton = new ui.ImageButton(ui.scriptLocation + "/assets/quiver_text-import_v01.png");
...
var convertRectButton = new ui.ImageButton(ui.scriptLocation+"/assets/quiver_icon-rectangle_v01.png");
...
var dynamicAlignButton = new ui.ImageButton(ui.scriptLocation+"/assets/quiver_icon-align_v01.png");
...
var flattenShapeButton = new ui.ImageButton(ui.scriptLocation+"/assets/quiver_icon-flatten_v01.png");
...
var cycleTextAlignButton = new ui.ImageButton(ui.scriptLocation+"/assets/quiver_icon-text-horizontal-left_v01.png");
...
var cycleVerticalTextAlignButton = new ui.ImageButton(ui.scriptLocation+"/assets/quiver_icon-text-vertical-top_v01.png");
...
function updateTextAlignIcon() {
    try {
        ...
        var iconPath = ui.scriptLocation + "/assets/quiver_icon-text-horizontal-left_v01.png";
            ...
            for (var i = 0; i < selection.length; i++) {
                ...
                if (isTextShape) {
                    ...
                    try {
                        ...
                        // 0 = Left, 1 = Centre, 2 = Right, 3 = Justified
                        if (alignment === 1) {
                            iconPath = ui.scriptLocation + "/assets/quiver_icon-text-horizontal-center_v01.png";
                        } else if (alignment === 2) {
                            iconPath = ui.scriptLocation + "/assets/quiver_icon-text-horizontal-right_v01.png";
                        } else if (alignment === 3) {
                            iconPath = ui.scriptLocation + "/assets/quiver_icon-text-horizontal-justified_v01.png";
                        } else {
                            // 0 (Left) - show left icon
                            iconPath = ui.scriptLocation + "/assets/quiver_icon-text-horizontal-left_v01.png";
                        }
                    } catch (e) {}
...
function updateVerticalTextAlignIcon() {
    try {
        ...
        var iconPath = ui.scriptLocation + "/assets/quiver_icon-text-vertical-top_v01.png";
            ...
            for (var i = 0; i < selection.length; i++) {
                ...
                if (isTextShape) {
                    ...
                    try {
                        ...
                        if (alignment === 1) {
                            iconPath = ui.scriptLocation + "/assets/quiver_icon-text-vertical-middle_v01.png";
                        } else if (alignment === 2) {
                            iconPath = ui.scriptLocation + "/assets/quiver_icon-text-vertical-bottom_v01.png";
                        } else if (alignment === 3) {
                            iconPath = ui.scriptLocation + "/assets/quiver_icon-text-vertical-baseline_v01.png";
                        } else {
                            // 0 (Top) - show top icon
                            iconPath = ui.scriptLocation + "/assets/quiver_icon-text-vertical-top_v01.png";
                        }
                    } catch (e) {}
                    break; // Use first text shape found
                }
...
var renamerButton = new ui.ImageButton(ui.scriptLocation+"/assets/quiver_icon-apply_v01.png");
...
var cornerRadiusInput = new ui.LineEdit();
    ...
    // Version info
    var settingsLogo = new ui.ImageButton(ui.scriptLocation+"/assets/quiver_logo_v01.png");
...
var logo = new ui.ImageButton(ui.scriptLocation+"/assets/quiver_icon_v01.png");
